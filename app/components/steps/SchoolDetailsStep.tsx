...
const SchoolDetailsStep: React.FC<SchoolDetailsStepProps> = ({ formData, handleChange }) => {
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">School Details</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="md:col-span-2">
          ...
          <Input
            ...
            required
          />
          <p className="text-xs text-gray-500 mt-1">For identification; may be used with address for mailing or verification.</p>
        </div>
        ...
        <div>
          <Label htmlFor="provinceState" className="text-sm font-medium text-gray-700">
            Province/State *
          </Label>
          <Input
            id="provinceState"
